...
class WorkflowNodeInputSpec(WorkflowSocketDefinition):
    ...
    default: Any | None = Field(default=None, description="输入项默认值")
    ...
    json_schema: Any | None = Field(default=None, description="RJSF 的 JSON Schema")
    ui_schema: Any | None = Field(default=None, description="RJSF 的 UI Schema")
