...
const ChatMessageUserContent = memo(function ChatMessageUserContent({ mid }: { mid: string }) {
...
const ChatMessageAssistantContent = memo(function ChatMessageAssistantContent({
  mid,
  isLastSegment,
}: {
  mid: string;
...
const ChatMessageItemShell = memo(function ChatMessageItemShell({
  mid,
  isLastSegment,
  isOpen,
  onOpenChange,
  ...
  return (
    ...
    >
      ...
      >
        ...
        <ChatMessageUserContent mid={mid} />
      </CollapsibleTrigger>
...
const ChatMessageItemBody = memo(function ChatMessageItemBody({
  mid,
  isLastSegment,
}: {
  mid: string;
...
const ChatMessageItem = memo(function ChatMessageItem({
  ...
  const user = useAtomValue(messageAtomFamily(mid));
  if (!user) return null;
  return <ChatMessageItemBody mid={mid} isLastSegment={isLastSegment} />;
});
