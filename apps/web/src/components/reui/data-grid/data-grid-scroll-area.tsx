...
function DataGridScrollArea({ children, className, orientation = 'both', ...props }: DataGridScrollAreaProps) {
  ...
  return (
    <div ref={containerRef} className="relative">
      <ScrollAreaPrimitive.Root data-slot="data-grid-scroll-area" className={cn('relative', className)} {...props}>
        ...
        {showHorizontal && (
          ...
          >
            <ScrollAreaPrimitive.Thumb data-slot="data-grid-thumb" className="bg-border rounded-full relative flex-1" />
          </ScrollAreaPrimitive.Scrollbar>
        )}
