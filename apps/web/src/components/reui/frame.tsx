...
function FramePanel({ className, ...props }: React.ComponentProps<'div'> & { fit?: boolean }) {
  return (
    <div
      className={cn(
...
function FrameHeader({ className, ...props }: React.ComponentProps<'header'>) {
  return (
    <header
      className={cn('flex flex-col px-(--frame-panel-header-px) py-(--frame-panel-header-py)', className)}
...
function FrameFooter({ className, ...props }: React.ComponentProps<'footer'>) {
  return (
    <footer
      className={cn('flex flex-col gap-1 px-(--frame-panel-footer-px) py-(--frame-panel-footer-py)', className)}
