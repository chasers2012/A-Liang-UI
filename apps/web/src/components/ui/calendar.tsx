  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        dropdown: cn('absolute inset-0 opacity-0 bg-muted text-foreground', defaultClassNames.dropdown),
        caption_label: cn(
...
function CalendarDayButton({ className, day, modifiers, ...props }: React.ComponentPropsWithoutRef<typeof DayButton>) {
  const defaultClassNames = getDefaultClassNames();
