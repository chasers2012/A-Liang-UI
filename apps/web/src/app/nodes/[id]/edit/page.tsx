...
const NODE_EDIT_FORM_ID = "node-edit-form";
    ...
    <Page
      ...
      action={
        <PageFormHeaderActions
          formId={NODE_EDIT_FORM_ID}
          submitting={submitting}
          submitDisabled={!name.trim()}
          cancelHref={`/nodes/${encodeURIComponent(id)}`}
        />
      }
    >
      <form
        id={NODE_EDIT_FORM_ID}
      ...
      >
        ...
        <div className="space-y-2">
          <Label>源码</Label>
          <CodeJar id="edit-node-source" value={source} onChange={setSource} />
        </div>
      </form>
    </Page>
  );
